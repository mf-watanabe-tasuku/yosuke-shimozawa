...
?>
<ol class="styled_post_list1 clearfix<?php if($show_date) { echo ' show_date'; }; ?>">
<?php
...
?>
 <li class="clearfix">
   ...
   <div class="info">
    <a class="title" href="<?php the_permalink() ?>"><?php if(wp_is_mobile()) { trim_title(20); } else { trim_title(23); }; ?></a>
