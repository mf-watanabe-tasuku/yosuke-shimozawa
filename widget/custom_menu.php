...
<?php if($nav_menu1) { ?>
<div class="menu1">
 <?php if(!empty($nav_menu_headline1)) { ?><h5 class="menu_headline rich_font"><?php echo esc_html($nav_menu_headline1); ?></h5><?php }; ?>
 <?php wp_nav_menu( apply_filters( 'widget_nav_menu_args', $nav_menu_args1, $nav_menu1, $args, $instance ) ); ?>
</div>
<?php }; ?>
<?php if($nav_menu2) { ?>
<div class="menu2">
 <?php if(!empty($nav_menu_headline2)) { ?><h5 class="menu_headline rich_font"><?php echo esc_html($nav_menu_headline2); ?></h5><?php }; ?>
...
function register_tcdw_menu_widget() {
	register_widget( 'tcdw_menu_widget' );
}
add_action( 'widgets_init', 'register_tcdw_menu_widget' );
