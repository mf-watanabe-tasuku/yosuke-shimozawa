...
?>
<ol class="styled_post_list2 clearfix<?php if($show_date) { echo ' show_date'; }; ?>">
<?php
...
function register_styled_post_list2_widget() {
	register_widget( 'styled_post_list2_widget' );
}
add_action( 'widgets_init', 'register_styled_post_list2_widget' );
