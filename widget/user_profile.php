...
?>
  ...
  <?php if($desc) { ?><p class="user_desc"><?php echo wp_kses_post($desc); ?></p><?php }; ?>
...
function register_tcd_user_profile_widget() {
	register_widget( 'tcd_user_profile_widget' );
}
add_action( 'widgets_init', 'register_tcd_user_profile_widget' );
