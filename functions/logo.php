...
<div id="logo_image">
 <h1 class="logo">
  <a href="<?php echo esc_url($url); ?>/" title="<?php echo esc_attr($title); ?>">
   ...
   <img class="pc_logo_image" src="<?php bloginfo('template_directory'); ?>/img/header/yosukeshimozawa_logo.png" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" />
   <?php }; ?>
   <?php if(!empty($logo_image_mobile)) { ?>
   <img class="mobile_logo_image" src="<?php bloginfo('template_directory'); ?>/img/header/yosukeshimozawa_logo.png" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" />
