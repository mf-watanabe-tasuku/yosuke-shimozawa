...
function tcd_password_form() {
	...
	if ( $pw_content ) {
		...
		if ( $options['pw_btn_display' . $pw_content] ) {	
			...
			$output .= '<div><a class="c-pw__btn c-pw__btn--register" href="' . esc_url( $options['pw_btn_url' . $pw_content] ) . '"' . $target . '>' .  esc_html( $options['pw_btn_label' . $pw_content] ) .'</a></div>';
  ...
  $output .= '<div class="c-pw__box">';
	...
	if ( ! $pw_content ) {
		...
		$output .= '<div><label class="c-pw__box-label" for="' . $label . '">' . __( 'Password:', 'tcd-w' ) . '</label><input class="c-pw__box-input" name="post_password" id="' . $label . '" type="password" size="20"><input class="c-pw__btn c-pw__btn--submit" type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form' ) . '"></div></div></form>';
		...
		$output .= '<input class="c-pw__box-input" name="post_password" id="' . $label . '" type="password" size="20"><input class="c-pw__btn c-pw__btn--submit" type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form' ) . '"></div></div></form>';
