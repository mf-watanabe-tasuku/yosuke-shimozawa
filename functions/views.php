...
if ( SHOW_VIEWS_CUSTOM_FIELD_ADMIN_COLMUN && USE_VIEWS_CUSTOM_FIELD ) :
	...
	function views_admin_colmun_init() {
		add_filter( 'manage_posts_columns', 'cf_views_posts_columns', 10 );
		add_filter( 'manage_pages_columns', 'cf_views_posts_columns', 10 );
		add_action( 'manage_posts_custom_column', 'cf_views_posts_custom_column', 10, 2 );
		add_action( 'manage_pages_custom_column', 'cf_views_posts_custom_column', 10, 2 );
