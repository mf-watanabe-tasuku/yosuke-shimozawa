...
?>
    ...
    <div class="wrap">
     	...
     	<div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="http://tcdwp.info/dl057/birth/birth_tcd057.zip"><?php _e( 'Download the latest version', 'tcd-w' ); ?></a> 】</p>
     		<div id="mono_info">
...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_birth.xml';	
    $db_cache_field = 'birth-contempo-notifier-cache';
    $db_cache_field_last_updated = 'birth-contempo-notifier-last-updated';
